<div class="content-wrapper">
  ...
  <div class="row ">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">List Of Patients Details</h4>
  ...
  <div class="row ">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">List Of All Vaccines Details</h4>
          <div class="table-responsive">
            <table class="table">
              <tr>
                <th>name</th>
  ...
  <div class="row ">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">List Of All Patient Reports</h4>
          <div class="table-responsive">
            <table class="table">
              <tr>
                <th>patient id</th>
  ...
  <div class="row ">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">List Of All Bookings Appointments Details</h4>
          <div class="table-responsive">
            <table class="table">
              <tr>
                <th>Name</th>
