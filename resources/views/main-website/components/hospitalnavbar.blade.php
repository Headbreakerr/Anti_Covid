	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container d-flex align-items-center">
			...
			<li class="nav-item mx-5">
				<li class="nav-item mt-1 mx-1"><a href="{{route('login')}}" class="btn btn-secondary py-2 px-3">Hospital Login</a></li>
				<li class="nav-item mt-1"><a href="{{ route('registerhospital')}}" class="btn btn-secondary py-2 px-3">Hospital Register</a></li>
			</li>
